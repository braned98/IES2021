...
namespace FTN.Common
{
    ...
    public class ModelResourcesDesc
    {
        ...
        private void InitializeNotSettablePropertyIds()
        {
            ...
            notSettablePropertyIds.Add(ModelCode.PERIOD_TIMESERS);
            notSettablePropertyIds.Add(ModelCode.PROCESS_MARKETDOCS);
            ...
            notSettablePropertyIds.Add(ModelCode.TIMESERIES_MEASUREPOINTS);
        }
